...
(function(root) {
    ...
    var bhIndex = null;
    var rootPath = '';
    var treeHtml = '        <ul>                <li data-name="namespace:KrzysiekPiasecki" class="opened">                    <div style="padding-left:0px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="KrzysiekPiasecki.html">KrzysiekPiasecki</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="namespace:KrzysiekPiasecki_Dotpay" class="opened">                    <div style="padding-left:18px" class="hd">                        <span class="glyphicon glyphicon-play"></span><a href="KrzysiekPiasecki/Dotpay.html">Dotpay</a>                    </div>                    <div class="bd">                                <ul>                <li data-name="class:KrzysiekPiasecki_Dotpay_Credentials" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="KrzysiekPiasecki/Dotpay/Credentials.html">Credentials</a>                    </div>                </li>                            <li data-name="class:KrzysiekPiasecki_Dotpay_RequestBag" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="KrzysiekPiasecki/Dotpay/RequestBag.html">RequestBag</a>                    </div>                </li>                            <li data-name="class:KrzysiekPiasecki_Dotpay_ResponseBag" >                    <div style="padding-left:44px" class="hd leaf">                        <a href="KrzysiekPiasecki/Dotpay/ResponseBag.html">ResponseBag</a>                    </div>                </li>                </ul></div>                </li>                </ul></div>                </li>                </ul>';
    ...
    var searchIndex = [
            ...
            {"type": "Namespace", "link": "KrzysiekPiasecki.html", "name": "KrzysiekPiasecki", "doc": "Namespace KrzysiekPiasecki"},{"type": "Namespace", "link": "KrzysiekPiasecki/Dotpay.html", "name": "KrzysiekPiasecki\\Dotpay", "doc": "Namespace KrzysiekPiasecki\\Dotpay"},
            ...
            {"type": "Class", "fromName": "KrzysiekPiasecki\\Dotpay", "fromLink": "KrzysiekPiasecki/Dotpay.html", "link": "KrzysiekPiasecki/Dotpay/ResponseBag.html", "name": "KrzysiekPiasecki\\Dotpay\\ResponseBag", "doc": "&quot;&quot;"},
